...
HD_PWD='C:/Comprehensive/OSX/OSX.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mipsfpga_nexys4_ddr.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mipsfpga_nexys4_ddr.tcl -notrace
