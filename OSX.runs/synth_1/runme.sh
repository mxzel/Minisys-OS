...
HD_PWD='C:/Comprehensive/OSX/OSX.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mipsfpga_nexys4_ddr.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mipsfpga_nexys4_ddr.tcl
